...
//FUNCTION PROTOTYPES//
float findGradeAvg(int grades[], int MAXGRADE);    // finds grade average by taking array of grades and number of grades as parameters
...

{
	...
	while ( moreinput == 'y' || moreinput == 'Y')
	{
		...
		cout << firstname << ' ' << lastname << " has an average of " << average << endl;
		//FILL IN THE RETURNS//
...
float findGradeAvg(int grades[], int MAXGRADE)
